...
1. Если не хотите производить действия, описанные в разделе [«Установка»](#Установка) и [«Настройка»](#Настройка), пожалуйста, не пользуйтесь таймером. я ненавижу писать самостоятельно то, что уже качественно написано до меня.<br>
...
1. Сочетания <kbd>Ctrl+Context_Menu</kbd> и <kbd>Ctrl+Alt+Context_Menu</kbd> выбраны по следующим причинам:
    ...
    я использую/использовал более 400 пакетов → в кеймапе ни одного из них не была задействована клавиша <kbd>Context_Menu</kbd>.<br>
    Если:
