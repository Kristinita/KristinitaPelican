...
1. Начинал писать пакеты, когда у нас не было практически ничего из [основных возможностей Комнат](../Комнаты-Эрика/Основные-возможности). Попробуйте поиграть в любой из [Вс_Поллардов](http://www.forumsi.org/showthread.php?t=572) — вот под такие условия приходилось подстраиваться. Со временем функционал в рабочий прототип внедрялся, но ограничения, не позволяющие писать так, как хотелось бы, к сожалению, были и остаются.
