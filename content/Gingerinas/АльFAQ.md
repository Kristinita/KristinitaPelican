...
Нет. «Для меня» — означает для [целей, описанных выше](#Глобальные-цели-Комнат-Эрика). По моему мнению, далеко не все Ваши действия соответствуют им (в другой статье об этом более подробно).
...
Тестирования — имею в виду не юнит-тесты, а проверки, как запоминается информация с комнатами и без них? — я хотел запустить на этапе, когда уже будут готовы новые функции и проект будет показан специалистам.
