...
module.exports =
	...
	sublimetexttarget:
		src: ['<%= templates.paths.output_path %>/Sublime-Text/*.html']
	...
	kristinitatemptarget:
		src: ['<%= templates.paths.output_path %>/Programs/*.html']
		css: ['<%= templates.paths.output_path %>/theme/css/sections/kristinita-temp.css']
		dest: '<%= templates.paths.output_path %>/theme/css/sections/kristinita-temp.css'
	itarticlestarget:
	...
	sashablacktarget:
		...
		src: ['<%= templates.paths.output_path %>/Sasha-Black/*.html', '<%= templates.paths.output_path %>/Pages/*.html']
