...
######################
###
[OVERVIEW] Generate humans.txt file:
https://www.npmjs.com/package/grunt-humans-txt
http://humanstxt.org/

[NOTE] Generator outdated, you get a warning in console:
...
[GRUNT][NOTE] Needs “module.exports = (grunt) ->” instead of “module.exports =”, that don't get an error:
...
module.exports = (grunt) ->
	options:
		...
		commentStyle: 'c'
		###
		[INFO] Indentation of nested values:
		https://github.com/robinpokorny/grunt-humans-txt#tab
		###
		tab: '\t'

		###
		[INFO] Section, where last update date:
