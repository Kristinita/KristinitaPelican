...
[OPTIONS] https://www.npmjs.com/package/html-minifier#options-quick-reference

[INFO] I migrate to html-minifier from minimize:
...
module.exports =
	minify:
		options:
			...
			###
			[INFO] Disable, because I minify inlineCSS use a task “postcss:fixinlinehtml”
